...
class Post(models.Model):
    ...
    description = SummernoteTextField('Краткое описание', max_length=200)
    text = SummernoteTextField('Текст записи')
    ...
    page_journal = models.IntegerField('Номер страницы в журнале', default=None, blank=True, null=True)
    ...
    CARD_DISPLAY_CHOICES = [
        ...
        ('fullscreen', 'Фото на всю ширину + Заголовок поверх фото'),
        ('NoFoto', 'Без фото'),
    ]
